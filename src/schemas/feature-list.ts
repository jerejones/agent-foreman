/**
 * JSON Schema validation for legacy feature_list.json format
 * (auto-migrated to modular markdown)
 */
import type { FeatureList } from "../types/index.js";
    ...
    metadata: {
      ...
      properties: {
        ...
        tddMode: {
          ...
          description:
            "TDD enforcement mode: strict (tests required), recommended (tests suggested), disabled (no TDD)",
        },
      },
      additionalProperties: false,
    },
